-- ===================================================
-- MATH CRUSH COMPLETE SUPABASE POSTGRESQL SETUP SCRIPT
...
-- 3. Seed Math Questions for Level 1: Fractions
...
-- 4. Seed Math Questions for Level 2: Decimals
INSERT INTO questions (level_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES
...
-- 5. Seed Math Questions for Level 3: Percentages
INSERT INTO questions (level_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES
...
-- 6. Seed Math Questions for Level 4: Ratios
INSERT INTO questions (level_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES
...
-- 7. Seed Math Questions for Level 5: Basic Algebra & Geometry
INSERT INTO questions (level_id, question_text, option_a, option_b, option_c, option_d, correct_answer, explanation) VALUES
